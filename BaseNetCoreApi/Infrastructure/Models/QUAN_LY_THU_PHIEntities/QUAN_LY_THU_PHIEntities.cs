...
namespace BaseNetCoreApi.Infrastructure.Models.QUAN_LY_THU_PHIEntities;

public partial class QUAN_LY_THU_PHIEntities : DbContext
{
    public QUAN_LY_THU_PHIEntities()
    {
    }

    public QUAN_LY_THU_PHIEntities(DbContextOptions<QUAN_LY_THU_PHIEntities> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=42.112.27.32,21433;initial catalog=QLTP_TEST;user id=sa;password=QIG@104;MultipleActiveResultSets=True;App=EntityFramework;TrustServerCertificate=True");
